...
> = props => {
  ...
  const Delete = () => {
    fetch("http://localhost:3006/api/kingbookings/" + booking._id, {
      method: "DELETE",
      headers: {
  ...
  const bookingEdit = () => {
    fetch("http://localhost:3006/api/kingbookings/" + id, {
  ...
  return (
    ...
    <Navbar/>
      <div className="row container booking2">
        <h3 className="titledeta">Cuidado, estás editando la reserva de un usuario</h3>
        <form className="col s12">
          <div className="row">
            <div className="input-field col s6 bloue">
      ...
      <BookingButton3 onClick={Delete}>Eliminar</BookingButton3>
        <BookingButton className="editb5" onClick={bookingEdit}>Editar</BookingButton>
